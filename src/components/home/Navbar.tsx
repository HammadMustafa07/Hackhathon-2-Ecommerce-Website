  ...
  return (
    <div className="h-[132px] w-[1440px]">
      ...
      <div className="w-[685px] h-[22px] relative top-[10px] left-[382px] gap-[44px] flex items-center justify-evenly">
        <Link href={"/"} className="text-[#726E8D]">Home</Link>
        <Link href={"/pages/about"} className="text-[#726E8D]">About</Link>
        <Link href={"/pages/shoppingbasket"} className="text-[#726E8D]">Cart</Link>
        <Link href={"/pages/productlisting"} className="text-[#726E8D]">Products</Link>
